...
![ERD](https://github.com/dc-choi/school_manage_back/blob/develop/img/v2.0.0%20work%20flow.png)
...
- v2.0.0 () : 기존의 프로젝트는 유지보수하기에 적합한 구조는 아니였습니다. 그 문제를 해결하기 위해 다음 사항들을 변경하였습니다.
